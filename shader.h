...
public:
    ...
    // constructor 3 entrées : vertex, geometry et fragment
    Shader(std::string vShaderCode, std::string gShaderCode, std::string fShaderCode)
    {
    ...
    // constructeur 2 entrées : vertex et fragment
...
private:
    ...
    GLuint compileProgram(GLuint vertexShader, GLuint fragmentShader, GLuint geometryShader = 0)
    {
