...
public:
    ...
    void ProcessKeyboardMovement(Camera_Movement direction, float deltaTime)
    {
        ...
        // FPS movement: ignore the vertical component of the viewing direction so that the camera moves parallel to the ground plane
        glm::vec3 horizontalFront =
            glm::normalize(glm::vec3(this->Front.x, 0.0f, this->Front.z));
    ...
    void ProcessMouseMovement(float xoffset, float yoffset, GLboolean constrainPitch = true)
    {
        ...
        // Recompute Front, Right and Up vectors
        updateCameraVectors();
    }
